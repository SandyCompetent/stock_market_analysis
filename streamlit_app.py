...
cfg.UPDATE_SENTIMENT_CSV = st.sidebar.checkbox('Update Sentiment CSV', cfg.UPDATE_SENTIMENT_CSV)
...
fig_baseline = ut.plot_model_results(baseline_history, y_test_tech_scaled, base_preds_scaled, test_dates_tech,
                                     cfg.STOCK_SYMBOL, 'Single-Layer LSTM')
...
# --- UPDATED: Pass the figure object to st.pyplot() ---
fig_multi_layer = ut.plot_model_results(multi_layer_history, y_test_tech_scaled, multi_preds_scaled, test_dates_tech,
                                        cfg.STOCK_SYMBOL, 'Multi-Layer LSTM')
...
# --- UPDATED: Pass the figure object to st.pyplot() ---
fig_enhanced = ut.plot_model_results(enhanced_history, y_test_enh_scaled, enh_preds_scaled, test_dates_enh,
                                     cfg.STOCK_SYMBOL, 'Enhanced LSTM')
...
# --- UPDATED: Pass the figure object to st.pyplot() ---
fig_multi_enhanced = ut.plot_model_results(multi_enhanced_history, y_test_enh_scaled, multi_enh_preds_scaled,
                                           test_dates_enh, cfg.STOCK_SYMBOL, 'Multi-Layer Enhanced LSTM')
